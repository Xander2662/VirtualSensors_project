...
void AppSelectionGui::constructAppSelection(void)
{
    ...
    lv_obj_set_height(ui_AppGroup, 10);
    ...
    lv_obj_set_height(ui_ComingSoonGroup, 10);
    lv_obj_set_x(ui_ComingSoonGroup, 160);
    lv_obj_set_y(ui_ComingSoonGroup, 80);
    lv_obj_clear_flag(ui_ComingSoonGroup, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_SCROLLABLE); /// Flags
    ...
    lv_obj_set_width(ui_ComingSoonLabel, 10);
